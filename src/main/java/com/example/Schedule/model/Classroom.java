...
public class Classroom {
    ...
    @Enumerated(EnumType.STRING) @Column(name = "room_type") private main.java.com.example.Schedule.model.enums.RoomType roomType = main.java.com.example.Schedule.model.enums.RoomType.LECTURE;
